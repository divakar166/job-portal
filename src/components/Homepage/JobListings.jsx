		...
		<section className="bg-white dark:bg-black px-4 py-3">
			<div className="container-xl lg:container m-auto">
				...
				<div className="flex justify-center items-center gap-x-4 py-4">
					<div
						className={`px-4 py-2 cursor-pointer rounded-full ${activeSection === "recommend" ? "bg-purple-500 text-white outline-none" : "outline-slate-200"} outline outline-1 hover:bg-purple-500 hover:text-white`}
						onClick={() => showSection("recommend")}
					>
						Recommended Jobs
					</div>
					<div
						className={`px-4 py-2 cursor-pointer rounded-full ${activeSection === "newJobs" ? "bg-purple-500 text-white outline-none" : "outline-slate-200"} outline outline-1 hover:bg-purple-500 hover:text-white`}
