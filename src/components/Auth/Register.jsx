    ...
    <section className="w-screen h-screen bg-gradient-to-r from-violet-300 to-violet-200  flex justify-center items-center">
      ...
      <div className="w-1/2 flex justify-center items-center">
        <div className="w-2/3 h-full bg-cover bg-center rounded-lg">
          <div className="text-4xl text-slate-700 my-5">Create an account</div>
          <div className="text-md my-4">Already have an account? <Link to='/auth/login' className="underline hover:text-purple-500">Login</Link></div>
          <form onSubmit={handleSubmit}>
            ...
            <button type="submit" className="w-full bg-purple-600 hover:bg-purple-500 text-white text-center py-3 rounded-lg">Create Account</button>
          </form>
        </div>
      </div>
      <ToastContainer
